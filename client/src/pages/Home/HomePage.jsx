      ...
      <div className="max-w-5xl mx-auto">
          ...
          <div className="relative">
            ...
            <SignedOut>
              <p className="text-xs text-muted mt-5">
                🔒 Щоденник шифрується так, що навіть ми не можемо його
                прочитати
              </p>
            </SignedOut>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-5 mt-10">
          <div className="bg-surface border border-border rounded-2xl p-6">
            ...
            <p className="text-sm text-ink">
              Опора - це те, на що спираєшся, коли самому важко встояти. Ми не
              намагаємось замінити психолога - натомість даємо простір, де можна
              чесно розібратися із собою, а за потреби легко дійти до людини,
              яка справді допоможе.
            </p>
          </div>
          <div className="bg-surface border border-border rounded-2xl p-6">
            <h2 className="text-lg font-extrabold text-ink mb-2">
            ...
            <p className="text-sm text-ink">
              Тим, хто відчуває тривогу, стрес чи вигорання і потребує допомоги
               - і тим, хто вже працює зі спеціалістом і
              хоче мати під рукою власні записи й інструменти між сесіями.
            </p>
          </div>
        </div>
        ...
        <div className="mt-14 bg-accent-soft border border-accent/30 rounded-3xl p-8 sm:p-10 text-center">
          ...
          <p className="text-sm sm:text-base text-ink max-w-xl mx-auto">
            В Опорі немає прямої оплати спеціалісту: замість цього кошти йдуть у
            благодійний фонд на твій вибір - зокрема на підтримку Збройних сил
            України. Отримуєш підтримку для себе - і водночас підтримуєш тих,
            хто боронить цю можливість для всіх нас.
          </p>
        </div>
        ...
        <div className="mt-8 bg-danger/5 border-2 border-danger/30 rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-center gap-4 sm:justify-between text-center sm:text-left">
          <div>
            ...
            <p className="text-sm text-ink mt-1">
              Гарячі лінії й вправи заземлення завжди доступні, без акаунту.
            </p>
          </div>
          <Link
            to="/crisis"
